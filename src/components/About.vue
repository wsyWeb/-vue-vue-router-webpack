<template>
	<div class="about">
		<canvas class="firworks"></canvas>
		<h1>当你进入这个页面的时候，说明我想要表达的东西已经完成了，我在页面里引入了animejs动画，因了解不够深入，不做更多阐述。如有任何问题，可以给我发邮件weisy@wise2c.com</h1>
	</div>
</template>
<script>
	...
	export default {
		...
		methods: {
			setAnimate() {
		      ...
		      var canvas = document.querySelector('.firworks');
